...
function getArtifactOfContract(contractName) {
  if (!contractName) {
    console.error("Invalid or missing contract name:", contractName);
  }
...
function getInheritedFunctions(mainArtifact) {
  ...
  for (const inheritanceContractName of inheritedFromContracts) {
    console.log("------------------- INHERITANCE", inheritanceContractName);
    const {
      abi,
      ast: { absolutePath },
...
function main() {
  ...
  chains.forEach((chain) => {
    ...
    transactionsCreate.forEach((transaction) => {
      console.log("ttttttttt--------------", transaction.contractName);
